...
namespace LivrariaVirtualApp.Domain.Models
{
    public class Book : Entity
    {
        ...
        public Book(string name, string isbn, string pg, string language,
                     ...
                     string pages, string overview, byte[] image)
        {
            this.Name = name;
            this.ISBN = isbn;
        ...
        {
            return $"Name:{Name}, ISBN:{ISBN}, Parental Guide:{Parental_guide}, Language:{Language}, Price:{Price}, Available:{Available}, Release Date:{Realease_date}," +
